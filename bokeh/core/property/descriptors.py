...
class PropertyDescriptor(object):
    ...
    def trigger_if_changed(self, obj, old):
        ...
        Args:
            obj (:class:`~bokeh.core.has_props.HasProps`)
...
class BasicPropertyDescriptor(PropertyDescriptor):
    ...
    def has_ref(self):
        ...
        For basic properties, this simply delegates to the property's
        ``has_ref`` attribute.
...
class UnitsSpecPropertyDescriptor(DataSpecPropertyDescriptor):
    ...
    def _extract_units(self, obj, value):
        ...
        When value is a dict, this function may mutate ``value``.
        ...
        Returns:
            ``value``, with 'units' key and value removed when applicable
